...
from ._argument import Arguments as DataClass
DataClassType = type(DataClass)


class GArgumentParser(ArgumentParser):
    """
    ...
    def _add_dataclass_arguments(self, dtype: DataClassType):
        for field in dataclasses.fields(dtype):
            ...
            if field.name in dtype.field_name_replace_dict:
                field_name = dtype.field_name_replace_dict[field_name]
